    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ((request.getParameter("username").equals("jsmith@toba.com")) && (request.getParameter("password").equals("letmein"))) {
                ...
                //RequestDispatcher dispatch = request.getRequestDispatcher("/Account_activity.html");
                ...
                response.sendRedirect(url);                  
                //RequestDispatcher dispatch = request.getRequestDispatcher("/Login_failure.html");
                //dispatch.forward(request, response);
